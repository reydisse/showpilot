/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 42f14b80a126eb6e5042f4a83b3e8361)
// Runtime types generated with workerd@1.20260305.0 2026-02-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ChatRelay" | "RundownRelay" | "LowerThirdsRelay" | "TimecodeRelay" | "BridgeRelay" | "CueSheetRelay";
	}
	interface Env {
		STORAGE: R2Bucket;
		DB: D1Database;
		...
		CHAT_RELAY: DurableObjectNamespace<import("./src/server").ChatRelay>;
		RUNDOWN_RELAY: DurableObjectNamespace<import("./src/server").RundownRelay>;
		LOWER_THIRDS_RELAY: DurableObjectNamespace<import("./src/server").LowerThirdsRelay>;
		TIMECODE_RELAY: DurableObjectNamespace<import("./src/server").TimecodeRelay>;
		BRIDGE_RELAY: DurableObjectNamespace<import("./src/server").BridgeRelay>;
		CUE_SHEET_RELAY: DurableObjectNamespace<import("./src/server").CueSheetRelay>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "CLOUDFLARE_ACCOUNT_ID" | "RESEND_API_KEY" | "KIOSK_SECRET" | "COMPANION_SECRET" | "STRIPE_SECRET_KEY" | "STRIPE_PRICE_STARTER" | "STRIPE_PRICE_PRO" | "STRIPE_PRICE_FOUNDING">> {}
}
