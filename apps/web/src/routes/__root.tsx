...
const THEME_BOOTSTRAP = `try{if(localStorage.getItem("showpilot-theme")==="light")document.documentElement.className="light"}catch(_){}`;
  ...
  head: () => ({
    meta: [
      ...
      { name: "viewport", content: "width=device-width, initial-scale=1, viewport-fit=cover" },
      {
        name: "description",
        content:
          "Run live productions with synchronized rundowns, timers, crew coordination, chat, notifications, and secure device control.",
      },
