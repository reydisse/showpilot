...
function emailWrapper(
  ...
  return `
    <!doctype html>
    <html lang="en" style="background-color:#0a0a0a;color-scheme:dark;">
    <head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="dark"><meta name="supported-color-schemes" content="dark"><title>ShowPilot</title></head>
    <body bgcolor="#0a0a0a" style="background-color:#0a0a0a;margin:0;padding:0;width:100%;">
