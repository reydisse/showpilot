...
describe("mobile notification destinations", () => {
  it("maps operational destinations to native screens", () => {
    expect(notificationRoute("schedule?date=2026-08-22&assignment=a1")).toEqual({ screen: "schedule" });
    ...
    expect(notificationRoute("https://showpilot.tech/faithfire-production/schedule?assignment=a1")).toEqual({ screen: "schedule" });
  });
