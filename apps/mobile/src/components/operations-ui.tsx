...
const useStyles = createThemedStyles((colors) => StyleSheet.create({
  ...
  panelTitle: { color: colors.text, fontFamily, fontSize: 16, fontWeight: "800" },
  ...
  statValue: { color: colors.text, fontFamily, fontSize: 23, fontWeight: "900" },
  statLabel: { color: colors.textMuted, fontFamily, fontSize: 11, fontWeight: "700", textTransform: "uppercase" },
  ...
  rowTitle: { color: colors.text, fontFamily, fontSize: 14, fontWeight: "700" },
  rowDetail: { color: colors.textMuted, fontFamily, fontSize: 12, lineHeight: 17 },
  status: { overflow: "hidden", borderRadius: radii.pill, backgroundColor: colors.panelStrong, color: colors.textMuted, fontFamily, fontSize: 10, fontWeight: "800", paddingHorizontal: 8, paddingVertical: 5, textTransform: "uppercase" },
