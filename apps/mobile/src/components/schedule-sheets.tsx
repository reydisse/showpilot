...
const useStyles = createThemedStyles((colors) => StyleSheet.create({
  ...
  eyebrow: { color: colors.amberText, fontFamily, fontSize: 9, fontWeight: "900", letterSpacing: 1.2 },
  ...
  picker: { gap: 7 },
  fieldLabel: { color: colors.textFaint, fontFamily, fontSize: 9, fontWeight: "900", letterSpacing: 1 },
  ...
  choiceMeta: { color: colors.textMuted, fontFamily, fontSize: 9 },
  hint: { color: colors.textFaint, fontFamily, fontSize: 10, lineHeight: 16 },
  ...
  responseLabel: { color: colors.textFaint, fontFamily, fontSize: 8, fontWeight: "900", letterSpacing: 0.8 },
  ...
  miniButtonPrimary: { color: colors.amberText, fontFamily, fontSize: 9, fontWeight: "900" },
  miniButtonDanger: { color: colors.red, fontFamily, fontSize: 9, fontWeight: "900" },
  ...
  optionText: { color: colors.textMuted, fontFamily, fontSize: 10, fontWeight: "800" },
