...
const useStyles = createThemedStyles((colors) => StyleSheet.create({
  ...
  title: { flexShrink: 1, color: colors.text, fontFamily, fontSize: 15, lineHeight: 21, fontWeight: "800" },
  badge: { overflow: "hidden", borderRadius: radii.pill, backgroundColor: colors.amberSoft, color: colors.amberText, fontFamily, fontSize: 11, lineHeight: 15, fontWeight: "900", paddingHorizontal: 7, paddingVertical: 3 },
