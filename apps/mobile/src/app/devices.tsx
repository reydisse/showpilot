...
const useStyles = createThemedStyles((colors) => StyleSheet.create({
  ...
  fleetLabel: { color: colors.textFaint, fontFamily, fontSize: 7, fontWeight: "900", letterSpacing: 0.7 },
  ...
  editorEyebrow: { color: colors.amberText, fontFamily, fontSize: 9, fontWeight: "900", letterSpacing: 1.2 },
  editorTitle: { color: colors.text, fontFamily, fontSize: 20, fontWeight: "900" },
  editorContent: { gap: 12, paddingBottom: 36 },
  fieldHeading: { color: colors.textFaint, fontFamily, fontSize: 9, fontWeight: "900", letterSpacing: 1.1, marginTop: 5 },
  adapterGrid: { gap: 7 },
  ...
  adapterMeta: { color: colors.textMuted, fontFamily, fontSize: 9, textTransform: "capitalize" },
  ...
  savedSecret: { color: colors.green, fontFamily, fontSize: 7, fontWeight: "900", letterSpacing: 0.6 },
  ...
  optionText: { color: colors.textMuted, fontFamily, fontSize: 10, fontWeight: "700" },
  ...
  enabledDescription: { color: colors.textMuted, fontFamily, fontSize: 9, lineHeight: 14 },
}));
