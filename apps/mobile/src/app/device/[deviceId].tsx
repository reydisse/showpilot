...
const useStyles = createThemedStyles((colors) => StyleSheet.create({
  ...
  status: { color: colors.textFaint, fontFamily, fontSize: 11, fontWeight: "900", letterSpacing: 0.7 },
  ...
  sectionTitle: { color: colors.textFaint, fontFamily, fontSize: 11, fontWeight: "900", letterSpacing: 1.3 },
  sectionCount: { overflow: "hidden", borderRadius: radii.pill, backgroundColor: colors.panelStrong, color: colors.amberText, fontFamily, fontSize: 11, fontWeight: "900", paddingHorizontal: 8, paddingVertical: 3 },
  actionList: { gap: 12 },
  ...
  category: { color: colors.amberText, fontFamily, fontSize: 11, fontWeight: "900", textTransform: "uppercase" },
  ...
  range: { color: colors.textFaint, fontFamily, fontSize: 11 },
  ...
  feedbackLabel: { color: colors.textFaint, fontFamily, fontSize: 11, fontWeight: "800", textTransform: "uppercase" },
  feedbackValue: { color: colors.green, fontFamily, fontSize: 15, fontWeight: "900" },
  feedbackWaiting: { color: colors.textFaint, fontSize: 11 },
