...
const useStyles = createThemedStyles((colors) => StyleSheet.create({
  ...
  showPickerHint: { color: colors.textFaint, fontFamily, fontSize: 8, fontWeight: "900", letterSpacing: 1.1 },
  ...
  sectionLabel: { color: colors.amberText, fontFamily, fontSize: 9, fontWeight: "900", letterSpacing: 1.2 },
  ...
  choiceText: { color: colors.textMuted, fontFamily, fontSize: 10, fontWeight: "800" },
  ...
  groupTitle: { color: colors.textMuted, fontFamily, fontSize: 10, fontWeight: "900", letterSpacing: 1.2, textTransform: "uppercase" },
  groupCount: { color: colors.textFaint, fontFamily, fontSize: 10, fontWeight: "700" },
  ...
  entryMeta: { color: colors.textFaint, fontFamily, fontSize: 9 },
  ...
  departmentButtonText: { color: colors.textMuted, fontFamily, fontSize: 9, fontWeight: "800" },
  departmentReadOnly: { color: colors.textFaint, fontFamily, fontSize: 9, fontWeight: "800" },
  ...
  modalEyebrow: { color: colors.amberText, fontFamily, fontSize: 9, fontWeight: "900", letterSpacing: 1.4 },
  ...
  showOptionDate: { color: colors.amberText, fontFamily, fontSize: 10, fontWeight: "900", textTransform: "uppercase" },
  showOptionName: { color: colors.text, fontFamily, fontSize: 14, fontWeight: "800" },
  showOptionStatus: { color: colors.textFaint, fontFamily, fontSize: 9, fontWeight: "800", textTransform: "uppercase" },
  ...
  suggestionDepartment: { overflow: "hidden", borderRadius: radii.pill, borderWidth: 1, borderColor: colors.border, color: colors.textMuted, fontFamily, fontSize: 8, fontWeight: "900", paddingHorizontal: 7, paddingVertical: 3 },
  suggestionReason: { color: colors.textMuted, fontFamily, fontSize: 11, lineHeight: 17 },
  existingTemplate: { color: colors.green, fontFamily, fontSize: 8, fontWeight: "900", letterSpacing: 0.8 },
