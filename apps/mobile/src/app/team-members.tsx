...
const useStyles = createThemedStyles((colors) => StyleSheet.create({
  ...
  memberMeta: { color: colors.textMuted, fontFamily, fontSize: 9, lineHeight: 14 },
  ...
  roleText: { color: colors.text, fontFamily, fontSize: 9, fontWeight: "900", textAlign: "center" },
  ...
  choiceDescription: { color: colors.textMuted, fontFamily, fontSize: 9, lineHeight: 14 },
