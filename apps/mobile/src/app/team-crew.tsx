...
const useStyles = createThemedStyles((colors) => StyleSheet.create({
  ...
  memberId: { color: colors.textMuted, fontFamily, fontSize: 8, fontWeight: "800", borderRadius: 5, backgroundColor: colors.panel, paddingHorizontal: 5, paddingVertical: 2 },
  memberRole: { color: colors.amberText, fontFamily, fontSize: 9, fontWeight: "800" },
  memberEmail: { color: colors.textMuted, fontFamily, fontSize: 9 },
  ...
  photoHint: { color: colors.textMuted, fontFamily, fontSize: 10, textAlign: "center" },
  label: { color: colors.textFaint, fontFamily, fontSize: 9, fontWeight: "900", letterSpacing: 1.2, marginTop: 3 },
  ...
  hint: { color: colors.textFaint, fontFamily, fontSize: 9, lineHeight: 13, marginTop: -6 },
  ...
  roleChoiceText: { color: colors.textMuted, fontFamily, fontSize: 9, fontWeight: "800" },
