...
const useStyles = createThemedStyles((colors) => StyleSheet.create({
  ...
  memberMeta: { color: colors.textMuted, fontFamily, fontSize: 11 },
  ...
  grantMeta: { color: colors.textMuted, fontFamily, fontSize: 11, lineHeight: 15 },
  ...
  revokeText: { color: colors.red, fontFamily, fontSize: 11, fontWeight: "900" },
  ...
  choiceMeta: { color: colors.textFaint, fontFamily, fontSize: 11 },
