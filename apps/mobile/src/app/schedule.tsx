...
const useStyles = createThemedStyles((colors) => StyleSheet.create({
  ...
  dateGoText: { color: colors.amberText, fontFamily, fontSize: 9, fontWeight: "900" },
  ...
  rangeButtonText: { color: colors.textMuted, fontFamily, fontSize: 8, fontWeight: "900" },
  ...
  providerUrl: { color: colors.textMuted, fontFamily, fontSize: 9 },
  ...
  statLabel: { color: colors.textFaint, fontFamily, fontSize: 7, fontWeight: "900", letterSpacing: 0.7 },
  ...
  dateMonth: { color: colors.amberText, fontFamily, fontSize: 8, fontWeight: "900", letterSpacing: 1 },
  cardCopy: { flex: 1, minWidth: 0, gap: 4 },
  title: { color: colors.text, fontFamily, fontSize: 15, fontWeight: "900" },
  fullDate: { color: colors.textMuted, fontFamily, fontSize: 10 },
  meta: { flexDirection: "row", flexWrap: "wrap", alignItems: "center", gap: 5 },
  metaText: { color: colors.textFaint, fontFamily, fontSize: 9, marginRight: 4 },
  ...
  metric: { overflow: "hidden", borderRadius: radii.pill, backgroundColor: colors.panelStrong, color: colors.textMuted, fontFamily, fontSize: 8, fontWeight: "800", paddingHorizontal: 7, paddingVertical: 4 },
  warning: { overflow: "hidden", borderRadius: radii.pill, backgroundColor: colors.amberSoft, color: colors.amberText, fontFamily, fontSize: 8, fontWeight: "900", paddingHorizontal: 7, paddingVertical: 4 },
  danger: { overflow: "hidden", borderRadius: radii.pill, backgroundColor: colors.redSoft, color: colors.red, fontFamily, fontSize: 8, fontWeight: "900", paddingHorizontal: 7, paddingVertical: 4 },
  ...
  smallActionText: { color: colors.textMuted, fontFamily, fontSize: 9, fontWeight: "800" },
  ...
  noAssignments: { color: colors.textFaint, fontFamily, fontSize: 10, lineHeight: 16, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: colors.borderSoft, padding: 12 },
  ...
  assignmentText: { color: colors.textMuted, fontFamily, fontSize: 9 },
  status: { color: colors.amberText, fontFamily, fontSize: 8, fontWeight: "900", textTransform: "uppercase" },
  confirmed: { color: colors.green },
  declined: { color: colors.red },
  managerNote: { color: colors.textMuted, fontFamily, fontSize: 10, lineHeight: 16 },
  responseNoteBox: { minWidth: 0, gap: 4, borderRadius: radii.small, backgroundColor: colors.redSoft, padding: 9 },
  responseNoteLabel: { color: colors.red, fontFamily, fontSize: 7, fontWeight: "900", letterSpacing: 0.8 },
  responseNote: { flexShrink: 1, color: colors.text, fontFamily, fontSize: 10, lineHeight: 16 },
  responseDate: { color: colors.textFaint, fontFamily, fontSize: 8 },
  ...
  confirmText: { color: colors.green, fontFamily, fontSize: 9, fontWeight: "900" },
  declineButton: { borderColor: colors.redBorder, backgroundColor: colors.redSoft },
  declineText: { color: colors.red, fontFamily, fontSize: 9, fontWeight: "900" },
  neutralButton: { borderColor: colors.border, backgroundColor: colors.panelStrong },
  neutralText: { color: colors.textMuted, fontFamily, fontSize: 9, fontWeight: "900" },
  declineForm: { gap: 8 },
