...
const sourceContract = [
  ...
  ["src/app/show-board.tsx", "useScreenPollingInterval(3_000)"],
  ...
  ["src/app/device/[deviceId].tsx", "<DeviceCockpit"],
  ["src/components/device-cockpit.tsx", 'surface === "switcher"'],
  ["src/components/device-cockpit.tsx", 'surface === "mixer"'],
  ["src/components/device-cockpit.tsx", 'surface === "display"'],
  ["src/components/device-cockpit.tsx", 'surface === "streaming"'],
  ["src/components/device-cockpit.tsx", 'surface === "lighting"'],
  ...
  ["src/app/stream.tsx", "useScreenPollingInterval(5_000)"],
  ...
  ["src/lib/mobile-api.ts", "responders: z"],
  ["src/lib/mobile-api.ts", "comments: z.array(incidentCommentSchema).default([])"],
  ["src/app/(app)/_layout.tsx", "useMobileBootstrap({ enabled: Boolean(session), poll: true })"],
  ["src/app/(app)/_layout.tsx", "!organization && organizationPending"],
  ["src/app/(app)/_layout.tsx", "organizationTimedOut"],
  ["src/providers/app-providers.tsx", "onlineManager.setEventListener"],
  ["src/providers/app-providers.tsx", 'refetchOnReconnect: "always"'],
  ["src/providers/app-providers.tsx", "returningToForeground"],
  ...
  ["src/lib/auth-client.ts", 'context.headers.set("expo-origin", "showpilot://")'],
  ["src/lib/env.ts", '__DEV__ || configuredUrl.startsWith("https://")'],
